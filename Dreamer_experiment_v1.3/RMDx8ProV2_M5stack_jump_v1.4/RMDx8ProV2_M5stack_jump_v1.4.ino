...
// トルク制限
float backward_max_torq = -8; // 振り戻し最大トルク
float forward_max_torq = 8; // 振り出し最大トルク

// 角度制限
float backward_max_ang = -90; // 振り戻し最大角度
...
void loop()
{
  while (exit_tf == false)
  {
    ...
    {
      Serial.print("Right_backward_max_ang_over");
      tgt_torq_R = 0;
      motor_state = 3;
      // exit_tf = true;
    }
    ...
    {
      Serial.print("Right_forward_max_ang_over");
      tgt_torq_R = 0;
      motor_state = 4;
      // exit_tf = true;
    }
